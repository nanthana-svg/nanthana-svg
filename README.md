...
**`Frontend Engineer`** — crafting interfaces that feel alive

[![Portfolio](https://img.shields.io/badge/portfolio-000000?style=for-the-badge&logo=About.me&logoColor=white)](#)
[![LinkedIn](https://img.shields.io/badge/linkedin-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](#)
[![Email](https://img.shields.io/badge/nanthana@binaryprofes.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:nanthana@binaryprofes.com)
...
```ts
const engineer = {
  name:          "Nanthana-Binary",
  username:      "nanthana-svg",
  role:          "Frontend Engineer",
  location:      "Thailand 🇹🇭",
  orgs:          ["Binary-Profes", "EUDR-THAI"],
  focus:         ["UI/UX", "Performance", "Clean Code"],
  currently:     "Building cool things with Binary-Profes ✦",
  contributions: "311 commits in 2026 and counting 🔥",
};
```

> _Obsessed with clean UI, smooth animations, and code that doesn't make future-me cry._
